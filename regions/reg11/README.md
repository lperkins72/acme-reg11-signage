...
This folder is the region-default content layer for `reg11`.
...
- `regions/reg11/data/primary-assets.json`
- `regions/reg11/data/primary.json`
- `regions/reg11/data/footer.json`
- `regions/reg11/data/primaryending.json`
- `regions/reg11/assets/primary/manifest.json`
- `regions/reg11/assets/footer/manifest.json`
...
Use this folder for region-wide defaults that should affect `reg11`.
